...
import type { Thuisbatterij } from "@/types/catalog";

// Configuration for Thuisbatterijen table
...
export async function GET(request: Request) {
  try {
    ...
    console.error("Error in thuisbatterijen API route:", error);
    return NextResponse.json(
      {
        error: "Failed to fetch thuisbatterijen",
